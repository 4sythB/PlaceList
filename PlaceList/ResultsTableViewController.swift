...
class ResultsTableViewController: UITableViewController {
    ...
    static let sharedController = ResultsTableViewController()
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        guard let presentingVC = self.presentingViewController as? MapViewController else { return }
        let item = matchingItems[indexPath.row]
        
        MapViewController.matchingItems = self.matchingItems
        presentingVC.item = item
...
extension MapViewController: UISearchBarDelegate {
    ...
    func searchBarSearchButtonClicked(searchBar: UISearchBar) {
        ...
        MapViewController.matchingItems = ResultsTableViewController.sharedController.matchingItems
