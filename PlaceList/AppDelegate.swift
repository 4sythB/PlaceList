...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        if SettingsController.sharedController.theme == .darkTheme {
            ...
            UILabel.appearance().tintColor = UIColor(red:0.19, green:0.20, blue:0.23, alpha:1.00)
            CopyableLabel.appearance().tintColor = UIColor(red:0.19, green:0.20, blue:0.23, alpha:1.00)
        }
